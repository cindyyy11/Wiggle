...
describe("Numeria quality and accessible controls", () => {
  ...
  it("shows an optional child-facing hand cursor without moving fallback controls into the canvas", async () => {
    render(<UniverseCanvas pizza={{ visible: true, selectedSlices: [], hand: { enabled: true, latest: { current: { pointer: { x: .2, y: -.4 }, gesture: "point", handedness: "right", confidence: .9, isTracking: true } }, gesture: "point", phase: null, status: "ready" } }} />);
