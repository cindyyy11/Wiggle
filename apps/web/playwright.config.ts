...
export default defineConfig({
  ...
  webServer: process.env.PLAYWRIGHT_EXTERNAL_SERVERS ? undefined : [
    ...
    { command: "node node_modules/next/dist/bin/next start --hostname 127.0.0.1 --port 3100", url: localURL, reuseExistingServer: false, env: { WIGGLE_API_URL: "", NEXT_PUBLIC_SUPABASE_URL: "", NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY: "" } },
    { command: "node node_modules/next/dist/bin/next start --hostname 127.0.0.1 --port 3101", url: connectedURL, reuseExistingServer: false, env: { WIGGLE_API_URL: "http://127.0.0.1:8101", NEXT_PUBLIC_SUPABASE_URL: "", NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY: "" } },
  ],
});
